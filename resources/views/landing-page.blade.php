...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img">
                        <img src="assets/img/jira.jpg" class="img-small" alt="Image">
                    </div>
                ...
                <div class="row g-0">
                    <div class="col-lg-12 order-lg-2 text-white  d-flex align-items-center justify-content-center" >
                        <img src="assets/img/imgjira.png" class="img-xs" alt="Image">
                    </div>
                </div>


                <div class="row g-0">
                    <div class="col-lg-12 order-lg-1 my-auto  d-flex align-items-center justify-content-center">
                        <h3 style="margin-top: 20px;">Jira</h3>
                         </div>
                </div>
            </div>
        </section>
        ...
        <section class="testimonials ">
            <div class="container">
                <h2 class="mb-5 text-center">What I am Using!!</h2>
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-center justify-content-center">
                        <div class="testimonial-pic mx-auto mb-5 mb-lg-0 ">
                            <img class="img-fluid mb-3 img-small " src="assets/img/laravel.png" alt="..." />
